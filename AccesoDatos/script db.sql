...
UPDATE DOMICILIOS SET ENTRECALLE1=NULL, ENTRECALLE2=NULL

DELETE FROM DOMICILIOS WHERE ID BETWEEN 13 AND 19
...
Select P.*, D.CALLE, D.ALTURA, L.NOMBRE as LOCALIDAD, D.ID AS IDDOM, D.PISO, D.DEPARTAMENTO, L.CODPOSTAL, L.PARTIDO from PROVEEDORES AS P LEFT JOIN DOMICILIOS AS D ON D.ID = P.IDDOMICILIO LEFT JOIN LOCALIDADES AS L ON L.ID = D.IDLOCALIDAD
